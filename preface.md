...
合并评审：是指在合并之前，允许多人对合并时所提交的变更内容进行代码审查，并给予合并意见的过程。
...
**3.79　运行环境 Runtime environment**

​     构建中运行的环境或者计算机

**3.80　源代码托管软件 Source code management software**

​     保存源代码的软件

**3.81　执行记录  Build history**

​     执行构建的信息，日志，以及结果。

**3.82　构建产出物  Build output**

​     构建任务中生产的文件

**3.83　软件单元测试 Software unit test**

​     软件中研发的自动化测试

**3.84　静态源代码扫描 Static code analysis**
